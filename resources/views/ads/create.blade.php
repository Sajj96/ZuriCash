                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('advert.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">AD Image</label>
                                    <div class="col-sm-12 col-md-7">
