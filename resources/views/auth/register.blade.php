                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <input id="phone" type="tel" class="form-control @error('phone') is-invalid @enderror d-block" name="phone" required autocomplete="phone" style="padding: 10px 80px 10px 90px">
                                                @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
        ...
        <!-- <div class="row">
            <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                <div class="login-brand">
                    <img alt="image" src="{{ asset('assets/img/logo4.jpeg')}}" width="100" class="header-logo mx-auto" />
                </div>
                <div class="card card-warning">
                    <div class="card-header">
                        <h4>{{ __('Register') }}</h4>
